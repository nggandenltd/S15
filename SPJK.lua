...
function bpspjk()
  MN9 = gg.multiChoice({
    "__•Antiban Lobby SPJK ©v2",
    "___•Block Report V2 [Lobby] (BETA)",
...
gg.refineNumber('"30356"', gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
...
-----------------------3rd---------------------
function hack3()
setvalue(gg.getRangesList('libUE4.so')[1].start+0x22bf3bc,4,0.0)
gg.toast("Aimbot Aktif...\n@admsprojecthack...")
end

function hackhs()
setvalue(gg.getRangesList('libUE4.so')[1].start+0x3906258,16,50)
gg.toast("HS Aktif...\n@admsprojecthack...")
end
---------------------4th-----------------------
function hack4()
