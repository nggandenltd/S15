...
gg.addListItems({[1] = {address = results[_FORV_6_].address + 48,flags = 4,freeze = true,value = 14555}})
gg.addListItems({[1] = {address = results[_FORV_6_].address + 100,flags = 4,freeze = true,value = -1}})
end
end
...
gg.clearResults()
gg.setRanges(gg.REGION_C_DATA)
    gg.searchNumber("h0000B4430000B4C30000344317B7D13800000000103A03EE101A02", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1)
noshake1=gg.getResults(gg.getResultsCount())
