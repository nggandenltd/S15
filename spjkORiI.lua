...
function HOME()
MENU = gg.multiChoice({
"📀 [Bypass_Lobby][32bit] Version_17 [Global]",
"💐 Wallhack & Collor [Island 1x]",
"🚧 Less Recoil [Lobby]",
"🎯 Headshot & Magic Bullet 50% [Lobby]",
"🙆 Antena [Island]",
"👣 High View [Game]",
"❌ ------≫ [EXIT SCRIPT]"
},nil,"🇮🇩『SPJK』S PROJECT HACK [VIP]\n🇮🇩 PUBGM 1.0.0")
if MENU == nil then
else
if MENU [1] == true then bypass2() end
if MENU [2] == true then wh() end 
if MENU [3] == true then less() end
if MENU [4] == true then hs() end 
if MENU [5] == true then antena() end
if MENU [6] == true then hv() end
...
gg.getResults(100)
gg.editAll("7",gg.TYPE_DWORD)
    gg.toast(' Color YELLOW SD 665 NEW ')
    gg.clearResults()
    end
